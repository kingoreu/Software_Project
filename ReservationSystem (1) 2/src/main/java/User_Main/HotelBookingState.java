...
public class HotelBookingState implements FormState {
    ...
    public void handle(BookingPopup context) {
        ...
        ButtonGroup hotelRegistrationGroup = new ButtonGroup();
        ButtonGroup airlineRegistrationGroup = new ButtonGroup();
        ButtonGroup carRegistrationGroup = new ButtonGroup();
        ...
        JPanel formPanel = builder
                ...
                .addLabel("호텔 등록 여부:", 20, 380, 100, 25)
                .addRadioButton("hotelRegistrationYes", "예", 140, 380, hotelRegistrationGroup)
                .addRadioButton("hotelRegistrationNo", "아니오", 200, 380, hotelRegistrationGroup)
                ...
                .addLabel("항공 등록 여부:", 20, 740, 100, 25)
                .addRadioButton("airlineRegistrationYes", "예", 140, 740, airlineRegistrationGroup)
                .addRadioButton("airlineRegistrationNo", "아니오", 200, 740, airlineRegistrationGroup)
                ...
                .addRadioButton("carRegistrationYes", "예", 170, 1060, carRegistrationGroup)
                .addRadioButton("carRegistrationNo", "아니오", 230, 1060, carRegistrationGroup)
